...
<li>
<a href="upgrades"> <i class="icon-energy"></i> <?php echo $user['energy']?> </a>
</li>
<?php if($user['is_admin'] == 1 && $mobileapp == false) { ?>
<li>
<a href="admin/index.php"> <i class="icon-wrench"></i> &nbsp Admin </a>
</li>
<?php } ?>
...
<!-- list item-->
<a href="<?php if($notification['url'] != '#') { echo '/'.$notification['url']; } else { echo '#'; } ?>" class="list-group-item">
<div class="media-box">
<div class="pull-left">
...
<img src="<?php echo getProfilePicture($domain,$user)?>" width="60" height="60" class="img-thumbnail img-circle user-picture">
</a>
...
<span><?php echo $lang['Upgrades']?></span>
<? } else { ?>
<em class="icon-star"></em>
<span><?php echo $config['subscription_name']?></span>
<? } ?>
</a>
</li>
...
<!-- START list title-->
<li class="p">
<small class="text-muted"><?php echo strtoupper($lang['Friends'])?></small>
</li>
<!-- END list title-->
<li>
...
<!-- Contact avatar-->
<img src="<?php echo getProfilePicture($domain, $chat_fr)?>" alt="<?php echo $chat_fr['full_name']?>" class="media-box-object img-circle thumb48">
</span>
<!-- Contact info-->
